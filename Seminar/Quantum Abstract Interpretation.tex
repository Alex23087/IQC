...
\begin{frame}{Focus}
	...
	\begin{itemize}[<+->]
		\item[Focus] - concretize to a new, finer domain with sufficient precision to accurately represent the operation;
...
\begin{frame}{Choice of Tuple S}
	...
	\begin{tabular}{| c | c | c |}
		...
		\hline
		More, bigger sets & \specialcell{More computational cost\\and memory footprint} & More precision\\
		\hline
	\end{tabular}\\
	}
	\vspace*{1em}
